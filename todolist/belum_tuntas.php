...
$h1 = mysqli_query($c,"SELECT * FROM tasks WHERE status = 'belum'");
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumlah Task Belum Tuntas: <?=$h2;?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $get = mysqli_query($c,"SELECT * FROM tasks WHERE status = 'belum'");
                                        $i = 1;
